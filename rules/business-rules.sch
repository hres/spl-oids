...
<!-- pbx: 1:33pm Sep 18 2018, rebuilt local env -->        
    ...
    <sch:let name="display-language" value="(document('.\properties.xml'))/report_message/display-language"/>
    ...
    <sch:pattern>
        ...
        <sch:rule context="manufacturedProduct/asContent/containerPackagedProduct">
            ...
            <!-- 
                At this time PCID values are not validated, uncomment when this will be enforced
